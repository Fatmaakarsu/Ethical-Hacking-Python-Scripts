...
# It found the MAC add from that IP add
...
def arp_poisoning(target_ip,poisoned_ip):
    ...
    # op=2 -> response ,  pdst -> destination ip , hwdst -> des. mac , psrc -> modem ip
...
# man in the middle is response at regular time intervals so that it stays constantly
try:
    while True:
